...
def main():
    ...
    p.add_argument("--num_cutouts", "-cutn", type=int, default=64, help="Number of randomly cut patches to distort from diffusion.")
    ...
    p.add_argument("--clip_guidance_scale", "-cgs", type=int, default=1500, help="Scale for CLIP spherical distance loss. Default value varies depending on image size.")
    p.add_argument("--tv_scale", "-tvs", type=int, default=150, help="Scale for denoising loss. Disabled by default for 64 and 128")
